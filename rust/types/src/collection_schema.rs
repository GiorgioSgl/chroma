...
impl Schema {
    ...
    pub fn reconcile_with_collection_config(
        ...
        Self::convert_collection_config_to_schema(collection_config, default_knn_index)
    }
    ...
    pub fn convert_collection_config_to_schema(
        collection_config: &InternalCollectionConfiguration,
        default_knn_index: KnnIndex,
    ) -> Result<Schema, SchemaError> {
...
mod tests {
    ...
    fn test_convert_schema_to_collection_config_hnsw_roundtrip() {
        ...
        let schema =
            Schema::convert_collection_config_to_schema(&collection_config, KnnIndex::Hnsw)
                .unwrap();
    ...
    fn test_convert_schema_to_collection_config_spann_roundtrip() {
        ...
        let schema =
            Schema::convert_collection_config_to_schema(&collection_config, KnnIndex::Spann)
                .unwrap();
        let reconstructed = InternalCollectionConfiguration::try_from(&schema).unwrap();
    ...
    fn test_defaults_source_key_not_document() {
        ...
        // This path calls convert_collection_config_to_schema where our fix is
    ...
    #[test]
    fn test_convert_collection_config_to_schema_source_key() {
        // Direct test of convert_collection_config_to_schema to verify source_key behavior
        ...
        let schema_hnsw =
            Schema::convert_collection_config_to_schema(&collection_config_hnsw, KnnIndex::Hnsw)
                .unwrap();
        ...
        let schema_spann =
            Schema::convert_collection_config_to_schema(&collection_config_spann, KnnIndex::Spann)
                .unwrap();
